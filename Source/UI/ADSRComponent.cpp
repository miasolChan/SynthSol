    ...
    juce::String parameterID, std::unique_ptr<Attachment>& sliderAttachment)
{
    ...
    slider.setColour(juce::Slider::ColourIds::textBoxTextColourId, CustomColours::creamWhite);
    addAndMakeVisible(slider);

    sliderAttachment = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(apvts, parameterID, slider);

    label.setColour(juce::Label::ColourIds::textColourId, CustomColours::creamWhite);
    label.setFont(15.0f);
